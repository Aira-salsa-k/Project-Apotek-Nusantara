...
<head>
    ...
    <title>Detail Hasil Rekam medis Konsultasi </title>
    <!-- Bootstrap CSS -->
...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-lg-10">
             <!-- Informasi ID dan Tanggal Konsultasi -->
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h6 class="text-muted mb-0">ID Konsultasi: <span class="fw-bold">KS-2024030001</span></h6>
                </div>
                <div>
                    <h6 class="text-muted mb-0">Tanggal Konsultasi: <span class="fw-bold">15 Mar 2024</span></h6>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 pe-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="fw-medium">Laki-laki</p>
                            </div>

                            <div class="mb-3">
                                <label class="mb-1">Umur</label>
                                <p class="fw-medium">28 Tahun</p>
                            </div>

                            <div class="mb-3">
                                <label class="mb-1">Alamat</label>
                                <p class="fw-medium">Jl. Contoh No. 123, Kota Malang</p>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <p class="fw-medium">Demam tinggi selama 3 hari, disertai dengan sakit kepala dan nyeri otot.</p>
                            </div>

                            <div class="mb-3">
                                <label class="mb-1">Riwayat Penyakit</label>
                                <p class="fw-medium">Asma (2015), Tifus (2018)</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 ps-md-4 border-start">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="fw-medium">dr. Sarah Johnson, Sp.PD</p>
                            </div>

                            <div class="mb-3">
                                <label class="mb-1">Spesialisasi</label>
                                <p class="fw-medium">Spesialis Penyakit Dalam</p>
                            </div>

                            <div class="mb-3">
                                <label class="mb-1">No. Lisensi Dokter</label>
                                <p class="fw-medium">IDI-123456789</p>
                            </div>
                        </div>
                    </div>
                </div>
