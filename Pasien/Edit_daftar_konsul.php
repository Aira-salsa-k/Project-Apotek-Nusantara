...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $TurnUrl = ($_SESSION['role'] === 'Pasien') 
    ? 'Dashboard_konsultasi.php' 
    ...
    // if ($conn->query($sql_update) === TRUE) {
    //     echo "<script>alert('Data konsultasi berhasil diperbarui!'); 
        
    //     window.location.href='Dashboard_konsultasi.php';</script>";
    // } else {
    //     echo "Error: " . $sql_update . "<br>" . $conn->error;
    // }
...
$backUrl = ($_SESSION['role'] === 'Pasien') ? 'Dashboard_konsultasi.php' : '../Petugas/Dashboard_petugas.php';
?>
